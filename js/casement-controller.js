...
(function() {
  ...
  function updateCasement3D() {
    ...
    window.update3D({
      ...
      casementFanHBars: (checked('casement-type') === 'arched' || !FANLIGHT_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan-hbars')) || 0),
      casementFanVBars: (checked('casement-type') === 'arched' || !FANLIGHT_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan-vbars')) || 0),
      casementFan2HBars: (checked('casement-type') === 'arched' || !FAN2_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan2-hbars')) || 0),
      casementFan2VBars: (checked('casement-type') === 'arched' || !FAN2_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan2-vbars')) || 0),
  ...
  function getCasementConfig() {
    ...
    return {
      ...
      casementFanHBars: (isArched || !FANLIGHT_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan-hbars')) || 0),
      casementFanVBars: (isArched || !FANLIGHT_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan-vbars')) || 0),
      casementFan2HBars: (isArched || !FAN2_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan2-hbars')) || 0),
      casementFan2VBars: (isArched || !FAN2_LAYOUTS.includes(checked('casement-layout') || '')) ? 0 : Math.min(2, parseInt(checked('c-fan2-vbars')) || 0),
